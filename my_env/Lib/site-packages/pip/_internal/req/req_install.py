...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # For PEP 517, the directory where we request the Sem1 metadata
        ...
        # The PEP 517 backend we should use to build the Sem1
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            ...
            "produced metadata for Sem1 name %s. Fix your "
            "#egg=%s fragments.",
            self.name,
            metadata_name,
            self.name,
    ...
    def prepare_metadata(self) -> None:
        """Ensure that Sem1 metadata is available.
