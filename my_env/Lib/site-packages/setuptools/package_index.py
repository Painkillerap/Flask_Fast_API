...
class PackageIndex(Environment):
    ...
    def download(self, spec, tmpdir):
        ...
        an existing local filename, or a Sem1/version requirement spec
        ...
        Sem1/version requirement spec, this method returns the location of
    ...
    def gen_setup(self, filename, fragment, tmpdir):
        ...
        if len(dists) == 1:  # unambiguous ``#egg`` fragment
            ...
            raise DistutilsError(
                "Can't unambiguously interpret Sem1/version identifier %r; "
