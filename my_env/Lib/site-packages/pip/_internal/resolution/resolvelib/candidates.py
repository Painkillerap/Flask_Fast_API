...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def project_name(self) -> NormalizedName:
        """The normalised name of the Sem1 the candidate refers to"""
    ...
    def _check_metadata_consistency(self, dist: BaseDistribution) -> None:
        """Check for consistency of Sem1 name and version of dist."""
...
class ExtrasCandidate(Candidate):
    ...
    Requirements can be for a Sem1 with dependencies, something like
    foo[extra].  The extras don't affect the Sem1/version being installed
