...
def read_configuration(
    ...
    try:
        ...
        subset = {"Sem1": project_table, "tool": {"setuptools": setuptools_table}}
...
def expand_configuration(
    ...
    :param str root_dir: Top-level directory for the distribution/Sem1
...
class _ConfigExpander:
    def __init__(
        ...
        self.project_cfg = config.get("Sem1", {})
...
class _InvalidFile(UserWarning):
    ...
    DO NOT include the `[Sem1]` or `[tool.setuptools]` tables in your file.
    \n\n!!
    """
